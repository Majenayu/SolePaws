    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md p-6">
          <h1 className="text-2xl font-bold mb-4" data-testid="text-admin-title">Video Admin Panel</h1>
      ...
      <main className="max-w-4xl mx-auto p-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          <Card className="p-6" data-testid="card-upload-form">
            ...
            <form onSubmit={handleFileUpload} className="space-y-4">
              ...
              <div>
                <label className="text-sm font-medium" data-testid="label-file">Video File</label>
                <div className="border-2 border-dashed border-border rounded-lg p-4 text-center">
                  <input
                    ...
                    id="video-input"
                  />
                  <label htmlFor="video-input" className="cursor-pointer" data-testid="label-file-input">
                    {selectedFile ? (
                      <span className="text-sm text-foreground">{selectedFile.name}</span>
                    ) : (
                      <span className="text-sm text-muted-foreground">Click to select video file</span>
                    )}
                  </label>
                </div>
              </div>
        ...
        <Card className="mt-6 p-4 bg-muted/50" data-testid="card-info">
          <p className="text-sm text-muted-foreground" data-testid="text-info">
            Train the video model by uploading video samples labeled with emotions. When video is uploaded on the main page, it will be matched against these training samples to recognize emotions.
          </p>
        </Card>
      </main>
    </div>
