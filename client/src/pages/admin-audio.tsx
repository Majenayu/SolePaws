    ...
    return (
      <div className="min-h-screen bg-background flex items-center justify-center p-4">
        <Card className="w-full max-w-md p-6">
          <h1 className="text-2xl font-bold mb-4" data-testid="text-admin-title">Audio Admin Panel</h1>
      ...
      <main className="max-w-4xl mx-auto p-6">
        ...
        <Card className="mt-6 p-4 bg-muted/50" data-testid="card-info">
          <p className="text-sm text-muted-foreground" data-testid="text-info">
            Train the audio model by uploading audio samples labeled with emotions. When audio is uploaded on the main page, it will be matched against these training samples to recognize emotions.
          </p>
        </Card>
      </main>
    </div>
